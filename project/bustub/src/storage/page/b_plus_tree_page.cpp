 ...
 */
auto BPlusTreePage::IsLeafPage() const -> bool { return IndexPageType::LEAF_PAGE == page_type_; }
auto BPlusTreePage::IsRootPage() const -> bool { return INVALID_PAGE_ID == parent_page_id_; }
